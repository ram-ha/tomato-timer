...
const fillRed = {
    start: {
        pathLength: 0,
        fill: 'rgba(250, 25, 25, 0)',
    },
    end: {
        pathLength: 1,
        fill: 'rgba(250, 25, 25, 1)',
    },
};
const fillRedDark = {
    start: {
...
const fillStroke = {
    start: {
        pathLength: 0,
        fill: 'rgba(255, 87, 95, 0)',
    },
    end: {
        pathLength: 1,
        fill: 'rgba(255, 87, 95, 1)',
    },
};
const fillGreen = {
    start: {
        pathLength: 0,
        fill: 'rgba(107, 225, 102, 0)',
    },
    end: {
        pathLength: 1,
        fill: 'rgba(107, 225, 102, 1)',
    },
};

const TomatoSVG = () => (
    <Svg viewBox="0 -84 1192 1192" className="icon" xmlns="http://www.w3.org/2000/svg">
        <motion.path
